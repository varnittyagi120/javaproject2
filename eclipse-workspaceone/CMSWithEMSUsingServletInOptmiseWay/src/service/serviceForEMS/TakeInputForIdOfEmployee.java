...
/**
 * Servlet implementation class TakeInputForIdOfEmployee
 */
@WebServlet("/TakeInputForIdOfEmployee")
public class TakeInputForIdOfEmployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		htmlCodeString.append("<!DOCTYPE html>").append("<html>").append("<body>").append("<style>")
				...
				.append("}").append("</style>")
				.append("<center><h1>Enter Id For Performing Selected Operation</h1></center>")
				...
				.append("<form action='"+url+"' method='POST'>").append("<p>Enter Employee Id :<br></p>")
