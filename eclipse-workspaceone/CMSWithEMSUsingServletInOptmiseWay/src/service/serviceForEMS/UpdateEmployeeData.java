...
public class UpdateEmployeeData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
//		if(request.getAttribute("valueOfId")==null) {
//		       response.setStatus(HttpServletResponse.SC_BAD_REQUEST);
//		}
		...
		htmlCodeString.append("<!DOCTYPE html>").append("<html>").append("<body>").append("<style>")
				...
				.append("<input type='hidden' name='url' value='UpdateEmployeeData'>")
				...
				.append("<input type = 'date' name = 'dateOfJoining' style='font-size:1rem' style='font-size:1rem' value = '"
				...
				.append("<input type = 'text' name = 'salary' style='font-size:1rem' value = '" + request.getAttribute("valueOfSalary")
						+ "'><br>")
