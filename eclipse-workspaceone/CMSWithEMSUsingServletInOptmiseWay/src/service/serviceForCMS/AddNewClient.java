...
//	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String valueOfBillAmount = request.getAttribute("valueOfBillAmount") == null ? "" : (String) request.getAttribute("valueOfBillAmount");
		String valueOfTenure = request.getAttribute("valueOfTenure") == null ? "" : (String) request.getAttribute("valueOfTenure");
		...
		htmlCodeString.append("<!DOCTYPE html>").append("<html>").append("<body>").append("<style>")
				...
				.append("<input type='hidden' name='url' value='AddNewClient'>")
				...
				.append("<input type = 'text' name = 'tenure' style='font-size:1rem' value = '" + valueOfTenure + "'><br>")
