 ...
 */
@WebServlet("/TakeInputForReadEmployee")
public class TakeInputForReadEmployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		htmlCodeString.append("<!DOCTYPE html>").append("<html>").append("<body>").append("<style>")
				...
				.append("}").append("</style>")
				.append("<center><h1>Enter Id For Fetching Employee Details</h1></center>")
				...
				.append("<form action='ReadEmployee' method='POST'>").append("<p>Enter Employee Id :<br></p>")
