...
public class UpdateEmployeeData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> list = databaseQueries.readEmployee(uid, employee);
		...
		request.setAttribute("valueOfDateOfJoining", list.get(5));
		request.setAttribute("valueOfSalary", list.get(6));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		htmlCodeString.append("<!DOCTYPE html>").append("<html>").append("<body>").append("<style>")
				...
				.append("}").append("</style>").append("<center><h1>Update Employee Details</h1></center>")
				.append("<fieldset style = 'margin-left:350px;border-radius:5px;background-color:#D0D3D4;padding:0px;width:600px;'>")
				.append("<form action='ValidateDuringUpdation' method='POST'>")
				...
				.append("<input type = 'text' name = 'email' value = '" + request.getAttribute("valueOfEmail")
						+ "'><br>")
				...
				.append("<input type = 'date' name = 'dateOfJoining' style='font-size:1rem' value = '"
						+ request.getAttribute("valueOfDateOfJoining") + "'><br>")
				.append("<span>" + errorInDateOfJoining + "</span>")
				.append("<p>Enter Salary :<br>(Must lie between 10000 to 100000 in numeric format)</p>")
				.append("<input type = 'text' name = 'salary' value = '" + request.getAttribute("valueOfSalary")
						+ "'><br>")
