...
/**
 * Servlet implementation class TakeInputForReadClient
 */
@WebServlet("/TakeInputForReadClient")
public class TakeInputForReadClient extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		htmlCodeString.append("<!DOCTYPE html>").append("<html>").append("<body>").append("<style>")
				...
				.append("}").append("</style>").append("<center><h1>Enter Id For Fetching Client Details</h1></center>")
				...
				.append("<form action='ReadClient' method='POST'>").append("<p>Enter Client Id :<br></p>")
