...
public class StartOfEMS extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        .append("<a href = \"TakeInputForReadEmployee\"><button class=\"button\" >ReadEmployeeData</button></a><br><br>")
        .append("<a href = \"ReadEmployees\"><button class=\"button\" >ReadEmployeesData</button></a><br><br><br>")
        .append("<a href = \"TakeInputForReadEmployee\"><button class=\"button\" >UpdateEmployeeData</button></a><br><br><br>")
        .append("<a href = \"TakeInputForDeletion\"><button class=\"button\" >DeleteEmployeeData</button></a><br><br>")
        .append("</fieldset>")
        .append("</body>")
        .append("</html>");
